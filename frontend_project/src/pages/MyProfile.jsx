...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    email: 'richardjamesap@gamil.com',
    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700 '>
          ...
          {
            isEdit ? <input className=' text-black max-w-52' type="text" value={userData.phone} onChange={(e) => setUserData((prev) => ({ ...prev, phone: e.target.value }))} /> : <p className='font-bold text-black' >{userData.phone}</p>
          }
